    ...
    : QWidget(parent)
{
    ...
    connect (penWidthSpinBox, static_cast<void (QSpinBox::*)(const int)>(&QSpinBox::valueChanged), this, &MainWidget::ShowPenWidth);

    penStyleLabel = new QLabel(tr("画笔风格:"));
    penStyleComboBox = new QComboBox;
    penStyleComboBox->addItem (tr("SlolidLine"), static_cast<int>(Qt::SolidLine));
    ...
    connect (penStyleComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWidget::ShowPenStyle);
    ...
    connect (penCapComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWidget::ShowPenCap);
    ...
    connect (penJoinComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWidget::ShowPenJoin);

    fillRuleLabel = new QLabel(tr("填充模式:"));
    fillRuleComboBox = new QComboBox;
    fillRuleComboBox->addItem (tr("Odd Even"), Qt::OddEvenFill);
    fillRuleComboBox->addItem (tr("Winding"), Qt::WindingFill);
    connect (fillRuleComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWidget::ShowFillRule);
    ...
    connect (spreadComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWidget::ShowSpreadStyle);
    ...
    connect (brushStyleComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWidget::ShowBrush);
