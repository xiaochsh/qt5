...
void MainWindow::creatToolBar()
{
    ...
    connect (styleComboBox, static_cast<void (QComboBox::*)(const int)>(&QComboBox::activated), this, &MainWindow::ShowStyle);
    widthLabel = new QLabel(tr("线宽:"));
    widthSpinBox = new QSpinBox;
    connect (widthSpinBox, static_cast<void (QSpinBox::*)(const int)>(&QSpinBox::valueChanged), drawWidget, &DrawWidget::setWidth);
