    ...
    : QDialog(parent)
{
    ...
    connect (serverNameLineEdit, &QLineEdit::textChanged, this, &TimeClient::enabelGetBtn);
    connect (portLineEdit, &QLineEdit::textChanged, this, &TimeClient::enabelGetBtn);
    connect (getBtn, &QPushButton::clicked, this, &TimeClient::getTime);
    connect (quitBtn, &QPushButton::clicked, this, &TimeClient::close);

    tcpSocket = new QTcpSocket(this);
    connect (tcpSocket, &QTcpSocket::readyRead, this, &TimeClient::readTime);
...
void TimeClient::showError (QAbstractSocket::SocketError socketError)
{
    ...
    case QAbstractSocket::ConnectionRefusedError:
        ...
        break;
    default:
        QMessageBox::information (this, tr("时间服务客户端"), tr("产生错误如下： %1").arg (tcpSocket->errorString ()));
